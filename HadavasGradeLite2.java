// Hadavas Calculus I Grade Calculator Version 5.0 - Lite Edition Version 2.0

public class HadavasGradeLite2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Juliana's Hadavas Calculus I Grade Calculator for Fall 2023 - Lite Edition! Version 5.0 \n");
		...
		if (argsLength == 1 && args[0].equals("help")) { // This section runs if the user only supplied one argument and it's "help".
			...
			System.out.println("To use the program, after the program name in the command line (HadavasGradeLite.java), input <Exam 1 Score> <Exam 2 Score> <Exam 3 Score> <Exam 4 Score> <Attendance Points> <Final Exam Score>. ");
			...
			if (canParseDouble(args[0]) && canParseDouble(args[1]) && canParseDouble(args[2]) && canParseDouble(args[3]) && canParseInt(args[4]) && finalExamValid) {
				...
				if ((examOne < 0 || examOne > 100.0) || (examTwo < 0 || examTwo > 100.0) || (examThree < 0 || examThree > 100.0) || (examFour < 0 || examFour > 110.0) || (attendancePoints < 0 || attendancePoints > 12) && valid) {
					valid = false;
				}
				if (valid) { // Only runs if the values given from the user are valid.
					...
					if (argsLength == 5) { // Runs only if the user supplied 5 arguments.
						...
						double midtermGrade = ((examOne + examTwo + examThree + examFour) - 10 + attendancePoints) / 4;
						double midtermPoints = ((examOne * 0.15) - 2.5) + ((examTwo * 0.15) - 2.5) + ((examThree * 0.15) - 2.5) + ((examFour * 0.15) - 2.5) + attendancePoints;
